...
export default function AboutSection() {
  const highlights = [
    ...
    "Real installs, real integrations — not a SaaS login",
    "AI added where it pays off, not for show",
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="accent-serif text-orange-300">first, last, always.</span>
            </h2>
            <p className="text-lg text-slate-300 mb-6 leading-relaxed">
              For 12 years, DSX has installed and supported the phone systems businesses run on —
              calls, routing, hosting, support. That's the work. That's the foundation.
            </p>
            <p className="text-slate-400 mb-8 leading-relaxed">
              DSX Edge is the same business, in the same place we've always been. We've just added
              a new option on top: when you want it, we layer in AI so the phones can answer,
              qualify, and schedule on their own. Communications first. Intelligence on top.
            </p>
            ...
            <div className="relative">
              ...
              <div className="relative card-glass rounded-2xl p-10">
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2">Same Business. New Layer.</h3>
                  <p className="text-slate-400 text-sm">
                    Communications is the foundation. AI is what we add on top
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center p-4 rounded-xl bg-orange-500/10 border border-orange-400/20">
                    ...
                    <div className="text-sm text-slate-400">Layered onto the Phones</div>
                  </div>
                  <div className="text-center p-4 rounded-xl bg-blue-500/10 border border-blue-400/20">
