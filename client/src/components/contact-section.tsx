    ...
    <section id="contact" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-5">Contact Us</h2>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          >
            ...
            <div className="bg-gradient-to-br from-blue-600 to-orange-500 rounded-2xl p-6 text-white">
              <h4 className="font-bold text-lg mb-2">Ready to save up to 60%?</h4>
              <p className="text-white/80 text-sm leading-relaxed">
                Join 500+ businesses that have already transformed their communication systems with DSX Edge.
              </p>
            </div>
          </motion.div>
        </div>
